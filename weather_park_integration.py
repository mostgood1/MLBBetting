...
class WeatherParkFactorEngine:
    ...
    def __init__(self, data_dir: str = None):
        ...
        # Weather API configuration with fallback
        self.weather_api_key = os.environ.get('WEATHER_API_KEY', '487d8b3060df1751a73e0f242629f0ca')
    ...
    def get_current_weather(self, home_team: str, game_date: str = None) -> Dict:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                logger.warning(f"Weather API authentication failed (401) - API key may need activation")
                return self._get_default_weather()
            elif response.status_code == 401:
                logger.warning(f"Weather API authentication failed (401) - API key may need activation")
                return self._get_default_weather()
            ...
            logger.warning(f"Weather data error: {str(e)}")
            return self._get_default_weather()
