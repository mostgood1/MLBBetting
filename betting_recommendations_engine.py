...
class BettingRecommendationsEngine:
    ...
    def apply_bullpen_adjustments(self, home_score, away_score, home_team, away_team):
        ...
        # Apply scoring boosts and away field advantage
        away_field_boost = getattr(self, 'away_field_boost', 0.0)
        adjusted_home = home_score * home_adjustment * self.home_scoring_boost
        adjusted_away = away_score * away_adjustment * self.away_scoring_boost * (1.0 + away_field_boost)
